...
namespace ComputerGamesCollection
{
    ...
    {
        //create selected index changed event through the listbox lightning bolt boys
        //global variables to hold array data
        string[] names = new string[20];
        string[] platforms = new string[20];
        string[] genres = new string[20];
        //used as counter to track number of entries made, increments with each click of the add button
        int entries = 0;
