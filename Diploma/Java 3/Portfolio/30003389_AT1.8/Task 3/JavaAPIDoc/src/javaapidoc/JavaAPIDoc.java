...
public class JavaAPIDoc {
     ...
     * @param carList contains the list of car objects to be the subject of the binary search
     * @param make contains the search term that is used to find the index of the car object
     * @return returns the index of the found object as an integer
     */
